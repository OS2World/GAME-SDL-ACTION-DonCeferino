...
/*!
 * \brief Realiza la impresion en pantalla utilizando la t�cnica Dirty Rectangles
 */
 ...
 * \param tam tama�o de la pelota (4 muy grande, 3 grande, 2 mediana, 1 chica
...
/*!
 * \brief genera un mensaje r�pido con los segundos disponibles
 *
